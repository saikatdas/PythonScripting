...
In this task, you'll be required to write message separated by and ending with '$'. Write Geeks$for$Geeks$. 
But we would be using end and sep parameters of print() to do so.'''
#{ 
#Driver Code Starts
